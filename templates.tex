...
\subsection{Extended Chinese Remainder Theorem}

Solve the system of congruences
$$
(x\equiv r_i\pmod{m_i})\ (\forall i\in\mathbb{N}\cap[0,n)).
$$
$\operatorname{lcm}_{i=0}^{n-1}m_i<10^{18}$ should be guaranteed to avoid overflow.

This is an \textbf{online} algorithm, i.e. the equations can be added one by one.
...
Time complexity: $O\left(n\log\left(\max_{i=0}^{n-1}m_i\right)\right)$.
Space complexity: $O(n)$. For the online version, the space complexity can be reduced to $O(1)$.
