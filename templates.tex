...
This is an \textbf{online} algorithm, i.e. the equations are be added one by one.
...
Time complexity: $O(\log m_i)$ for a single call. $O\left(n\log\left(\max_{i=0}^{n-1}m_i\right)\right)$ for the entire equation system.
