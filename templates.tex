...
% Print page number "0" on all front-matter pages (title, TOC).
% Using \renewcommand{\thepage}{0} ensures each preliminary page shows 0
% even if the TOC spans multiple pages.
\renewcommand{\thepage}{0}
\maketitle
\tableofcontents
\clearpage
% Restore normal arabic page numbering and start from page 1 for main content
